...
| 12 | [`12_agent_alignment_optimization.ipynb`](12_agent_alignment_optimization.ipynb) | How disjoint UC datasets, immutable prompt versions, readable real-call traces, and held-out runs prevent optimizer-to-production shortcuts — and how the judge itself is measured before it gates: per-run stability against frozen anchors, plus a committed kappa-vs-SME calibration record. |

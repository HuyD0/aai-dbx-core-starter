"""Render the deterministic beginner-first classification notebook course."""
...
def code(notebook: str, position: int, text: str):
    ...
    if 'required = ("mlflow", "pandas", "sklearn"' in source:
...
def render_lesson(filename: str, cells: list[tuple[str, str]]) -> str:
    ...
    notebook.metadata = {
        ...
        "aai_course": {
            ...
            "audience": "classification beginner",
        },
    }
...
def main() -> int:
    ...
    print(f"{verb} {len(LESSONS)} beginner lessons")
    return 0
